...
/*
	Note: If you declare a uniform that isn't used anywhere in your GLSL code the compiler will silently 
		  remove the variable from the compiled version which is the cause for several frustrating errors; keep this in mind!
*/
const char *fragmentShaderSourceA = 
	"#version 330 core \n"
    "out vec4 FragColour; \n"
	"uniform vec4 vertexColourA; \n"
    "void main() \n"
    "{\n"
    "   FragColour = vertexColourA; \n"
    "}\0";

const char *fragmentShaderSourceB = 
	"#version 330 core \n"
    "out vec4 FragColour; \n"
	"uniform vec4 vertexColourB; \n"
    "void main() \n"
    "{\n"
    "   FragColour = vertexColourB; \n"
    "}\0";
...
void draw()
{
	...
	*/
	...
	int vertexColourBLocation = glGetUniformLocation(shaderProgramIdB, "vertexColourB");
	glUseProgram(shaderProgramIdB);
	glUniform4f(vertexColourBLocation, 1.0f, 0.85f, value, 1.0f);
